...
/**
 * Establece la presencia dinámica del bot
 * @param {Client} client - instancia del bot
 * @param {string} [channelId] - opcional, canal donde enviar el embed al iniciar
 */
function setPresence(client, channelId) {
            ...
            activities: [
                {
                    ...
                    type: ActivityType.Playing // Puedes cambiar a Listening, Watching, Competing
                }
            ],
            status: 'online'
        });
    ...
    // Opcional: enviar embed al canal especificado
    if (channelId) {
